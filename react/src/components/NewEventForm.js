 ...
 return(
   <div className="column row submit-event">
     <div className= 'new-event-button'>
       <center><button type="button" onClick={props.handleFormButtonClick} className='button create-event small-12 medium-10 large-4 medium-centered large-centered columns'>Create an Event</button></center>
     </div>
